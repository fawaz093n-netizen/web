...
For a full app scaffold, start from [Choose a setup path](/next/getting-started). That path creates the project files and package scripts for you. This CLI reference is for the lower-level commands those scripts call.

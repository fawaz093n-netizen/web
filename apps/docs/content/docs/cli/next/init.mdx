...
Use [Choose a setup path](/next/getting-started) when you want a complete new application template. Use `prisma-next init` when you already have a project and want to add the lower-level Prisma Next files.

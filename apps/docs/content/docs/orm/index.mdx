...
Prisma Next is the next major version of Prisma ORM, available now in Early Access. Start with the [Prisma Next getting started guide](/next) and share feedback in [Discord](https://pris.ly/discord?utm_source=docs&utm_medium=inline_text).

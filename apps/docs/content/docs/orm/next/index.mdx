...
metaDescription: Prisma Next is a ground-up rethink of Prisma ORM with better queries, extensibility, migrations, and AI-friendly workflows, keeping the schema-first approach.
badge: early-access
---
...
<Cards>
  <Card href="/next/quickstart/postgresql" title="Quickstart" icon={<Rocket className="text-primary" />}>
    Scaffold a Prisma Next app with PostgreSQL, seed it, and run your first query.
  </Card>
  <Card href="/next/add-to-existing-project/postgresql" title="Add to an existing project" icon={<FolderPlus className="text-primary" />}>
    Add Prisma Next to an existing app with `prisma-next init`.
  </Card>
  <Card href="/" title="The full stack path" icon={<Milestone className="text-primary" />}>
    Prisma Next with Prisma Postgres and a Prisma Compute deploy, with guide and agent options.
  </Card>
</Cards>

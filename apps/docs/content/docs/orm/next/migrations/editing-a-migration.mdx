...
metaDescription: How to edit a Prisma Next migration.ts by filling placeholder data transforms, writing typed backfills, using rawSql, and recompiling ops.json with node migration.ts.
badge: early-access
---

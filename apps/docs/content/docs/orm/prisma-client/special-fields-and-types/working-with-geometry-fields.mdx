...
url: /orm/latest/prisma-client/special-fields-and-types/working-with-geometry-fields
...
- [Filtering and sorting](/orm/v6/prisma-client/queries/filtering-and-sorting) for more filter options

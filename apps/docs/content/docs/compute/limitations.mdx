...
metaDescription: Known Prisma Compute limitations during Early Access, covering framework support, env updates, and log streaming.
---

Known caveats while Compute is in Early Access.

...
<Cards>
  <Card href="/compute-internal/quickstart/nextjs" title="Next.js">
    Scaffold, enable standalone output, and deploy.
  </Card>
  <Card href="/compute-internal/quickstart/astro" title="Astro">
    Set up the Node adapter in standalone mode and deploy on port 4321.
  </Card>
  <Card href="/compute-internal/quickstart/nuxt" title="Nuxt">
    Scaffold and deploy with the default Nitro node-server preset.
  </Card>
  <Card href="/compute-internal/quickstart/tanstack-start" title="TanStack Start">
    Deploy the official Vite plus Nitro starter.
  </Card>
  <Card href="/compute-internal/quickstart/bun" title="Bun">

...
Choose PostgreSQL, set `DATABASE_URL` to your Prisma Postgres connection string, and let init add `prisma-next.md`, package scripts, and the Prisma Next skills for your coding agent. Then use the generated package scripts for the first contract, migration, seed, and query steps.

...
Prisma Next is the next major version of Prisma ORM, available now in Early Access. Expect its APIs to change as they stabilize, and [share your feedback in Discord](https://pris.ly/discord). Prisma 7 is the current generally available release, so if you are building for production, keep using [Prisma 7](/).

...
Prisma Next is the next major version of Prisma ORM, available now in Early Access. It is a ground-up rebuild of the ORM runtime, query APIs, migration flow, and project setup.

:::note[Prisma Next is in Early Access]

Its APIs will keep changing as they stabilize, so try it out and [share your feedback in Discord](https://pris.ly/discord). Prisma 7 is the current generally available release, so if you are building for production, keep using [Prisma 7](/).

...
const postgresStructuredData = createSoftwareApplicationStructuredData({
  ...
  description:
    "Managed serverless PostgreSQL database built for modern applications. Instant provisioning, zero configuration, global availability, connection pooling, automated backups, and encryption at rest and in transit — all managed automatically. Free to start.",
  ...
  offers: {
    ...
    name: "Free tier",
    description:
      "Free to start. Usage-based pricing for higher tiers with no surprise bills.",
  },
});

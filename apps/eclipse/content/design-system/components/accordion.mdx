  ...
  return (
    <Accordions type="single">
      <Accordion title="What is Prisma?">
        Prisma is a next-generation ORM that makes working with databases easy for application
        developers.
      </Accordion>
...
export function MultipleAccordion() {
  return (
    <Accordions type="multiple">
      ...
      <Accordion title="Configuration">Configure your settings in the config file.</Accordion>
      <Accordion title="Usage">Import and use the components in your app.</Accordion>
    </Accordions>
  );
}
```

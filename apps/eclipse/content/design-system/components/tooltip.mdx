...
```tsx
import { Tooltip, TooltipContent, TooltipProvider, TooltipTrigger, Button } from "@prisma/eclipse";
...
<TooltipProvider>
  <Tooltip>
    <TooltipTrigger asChild>
      <p className="truncate max-w-xs">This is a very long text that will be truncated...</p>
    </TooltipTrigger>
    <TooltipContent>

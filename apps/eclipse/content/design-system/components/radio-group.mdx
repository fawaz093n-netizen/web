...
export function ControlledRadioGroup() {
  ...
  return (
    <div className="space-y-4">
      ...
      <span className="text-sm text-foreground-neutral-weak">Selected: {value}</span>
    </div>
  );
}
```
  ...
  return (
    <RadioGroup defaultValue="option-one">
      <div className="flex items-center gap-2">
        ...
        <label htmlFor="disabled-one" className="text-sm font-medium opacity-70 cursor-not-allowed">
          Disabled option (selected)
        </label>
      </div>
      <div className="flex items-center gap-2">
        <RadioGroupItem value="option-two" id="disabled-two" disabled />
        <label htmlFor="disabled-two" className="text-sm font-medium opacity-70 cursor-not-allowed">
          Disabled option
        </label>
      </div>
      <div className="flex items-center gap-2">
    ...
    <RadioGroup defaultValue="standard" name="shipping">
      <div className="flex items-center justify-between p-4 border rounded-lg">
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col gap-1">
            <label htmlFor="standard-shipping-form" className="text-sm font-medium">
              Standard Shipping
            </label>
            <span className="text-sm text-foreground-neutral-weak">5-7 business days</span>
          </div>
      ...
      <div className="flex items-center justify-between p-4 border rounded-lg">
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col gap-1">
            <label htmlFor="express-shipping-form" className="text-sm font-medium">
              Express Shipping
            </label>
            <span className="text-sm text-foreground-neutral-weak">2-3 business days</span>
          </div>
      ...
      <div className="flex items-center justify-between p-4 border rounded-lg">
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col gap-1">
            <label htmlFor="overnight-shipping-form" className="text-sm font-medium">
              Overnight Shipping
            </label>
            <span className="text-sm text-foreground-neutral-weak">Next business day</span>
          </div>

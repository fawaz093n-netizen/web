...
export function TextareaWithCount() {
  return <Textarea placeholder="Enter up to 200 characters..." maxLength={200} showCharCount />;
}
```
...
<div className="max-w-md my-4">
  <Textarea placeholder="Enter up to 200 characters..." maxLength={200} showCharCount />
</div>
...
export function TextareaLimits() {
  return (
    <div className="space-y-4 max-w-md">
      ...
      <Textarea placeholder="Medium text (150 chars)" maxLength={150} showCharCount />
...
export function TextareaFieldWithCount() {
  return (
    <Field>
      ...
      <Textarea id="description" placeholder="Enter description..." maxLength={300} showCharCount />
...
export function InvalidTextareaWithField() {
  return (
    <Field>
      ...
      <Textarea id="feedback-invalid" defaultValue="Too short" aria-invalid="true" />
...
<div className="max-w-md my-4">
  <Field>
    ...
    <FieldDescription>We'd love to hear your thoughts.</FieldDescription>
    <Textarea id="feedback-invalid-field" defaultValue="Too short" aria-invalid="true" />
    <FieldError>Feedback must be at least 10 characters long</FieldError>
  </Field>
</div>
...
export function InvalidTextarea() {
  return (
    <div className="space-y-2 max-w-md">
      ...
      <Textarea id="invalid-feedback" defaultValue="Too short" aria-invalid="true" />
  ...
  return (
    <div className="space-y-4 max-w-md">
      <Textarea
        ...
        showCharCount
      />
      <p className="text-sm text-muted-foreground">You typed: {value || "(nothing yet)"}</p>
    </div>
  );
}
```
...
export function FormWithValidation() {
  ...
  return (
    <form>
      ...
      />
      {errors.description && (
        <span className="text-sm text-foreground-error">{errors.description.message}</span>
      )}
    </form>
  );
}

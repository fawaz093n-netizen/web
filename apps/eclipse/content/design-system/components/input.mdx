...
export function InvalidInputWithField() {
  return (
    <Field>
      ...
      <Input id="email-invalid" type="email" defaultValue="invalid-email" aria-invalid="true" />
...
<div className="max-w-md my-4">
  <Field>
    ...
    <Input id="email-invalid-field" type="email" defaultValue="invalid-email" aria-invalid="true" />
    <FieldDescription>We'll send updates to this address.</FieldDescription>
    <FieldError>Please enter a valid email address</FieldError>
  </Field>
</div>
  ...
  return (
    <div className="space-y-4 max-w-md">
      <div className="space-y-2">
        ...
        <Input id="invalid-email" type="email" defaultValue="invalid-email" aria-invalid="true" />
      ...
      <div className="space-y-2">
        ...
        <Input id="invalid-password" type="password" defaultValue="123" aria-invalid="true" />
        <span className="text-sm text-foreground-error block">
...
<div className="space-y-4 max-w-md my-4">
  <div className="space-y-2">
    ...
    <Input id="invalid-email" type="email" defaultValue="invalid-email" aria-invalid="true" />
    <span className="text-sm text-foreground-error">Please enter a valid email address</span>
  </div>
  <div className="space-y-2">
    <label htmlFor="invalid-password" className="text-sm font-medium">
      Password
    ...
    <Input id="invalid-password" type="password" defaultValue="123" aria-invalid="true" />
    <span className="text-sm text-foreground-error">Password must be at least 8 characters</span>
  </div>
</div>

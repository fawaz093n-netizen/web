...
>
  <div style={{ marginBottom: "20px", fontSize: "20px", color: "#2d3748", lineHeight: "32px" }}>
    Cold starts are a real pain. Unikraft Cloud provides cold starts in the order of a few
    milliseconds with hardware-level isolation.
  </div>
</Quotes>
...
<br />
<br />
After setting up the database, you will receive instructions for downloading and running a sample
project.

...
<Button asChild variant="ppg" className="no-underline hover:no-underline w-fit mx-auto px-4">
  <a href="https://github.com/prisma/try-prisma">Head over to the try-prisma repository</a>
</Button>

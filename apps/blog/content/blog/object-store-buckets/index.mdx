---
title: "Give Your Agent File Storage: Object Store Buckets"
...
And the teardown deleted a bucket that still had an object in it. Deleting a bucket takes its contents and its access keys with it in one call: no empty-the-bucket-first ritual, which cuts both ways, as the next section says.
